package com.xantrikoding.myviewmodel
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // untuk mengecek apakah my_edit_teks ada teksnya atau kosong
        setMyButtonEnable()

        // untuk memastikan saat terjadi input, my_button otomastis menjadi enable
